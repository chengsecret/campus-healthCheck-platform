...
public class UserHealthInfo implements Serializable {
    ...
    public UserHealthInfo(User user, HealthInfo healthinfo){
        this.name = user.getName();
        this.num = user.getNum();
        this.classnum = user.getClassnum();
        this.color = healthinfo.getColor();
        this.reason = healthinfo.getReason();
        this.updatetime = healthinfo.getUpdatetime();
        this.continuousnum = healthinfo.getContinuousnum();
